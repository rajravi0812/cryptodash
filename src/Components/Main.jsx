    ...
    return(
        <div className="container">
            <div className="row mt-2">
                <div className="col-2">
                    <select onChange={(e)=>dispatch(currency(e.target.value))} className="form-select" aria-label="Default select example">
            ...
            <div className="row gx-1 shadow-sm mb-3"style={{backgroundColor:"white",borderRadius:"8px"}} >
                ...
                <div className="mt-3" role="group" >
                    <input onClick={()=>{dispatch(oneAction())}} type="radio" className="btn-check" name="btnradio" id="btnradio1" autoComplete="off" defaultChecked />
                    <label style={{fontSize:"13px",fontWeight:"bold"}}className=" mx-1 btn btn-outline bg-body-tertiary" htmlFor="btnradio1">1D</label>
                    ...
                    <input onClick={()=>{dispatch(monthAction())}}  type="radio" className="btn-check" name="btnradio" id="btnradio3" autoComplete="off"/>
                ...
                <div className="col">
                    <div className="row">
                        ...
                        <div className="col p-3" >
                            ...
                            <option defaultValue="1">Chart type</option>
                            <option  value="1">Bar chart horizontal</option>
                            <option  value="2">Line</option>
                            <option value="1"> Bar chart verical</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    {setgraph==="1"?<Linechart/>:(setgraph==="2")?<Barcharts/>:<Barcharts/> }
                    </div>
